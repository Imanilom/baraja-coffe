...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(1)  String id, @HiveField(2)  String? name, @HiveField(3)  int? originalPrice, @HiveField(4)  int? discountedPrice, @HiveField(5)  String? description, @HiveField(6)  String? mainCategory, @HiveField(7)  String? subCategory, @HiveField(8)@JsonKey(name: 'imageUrl')  String? imageURL, @HiveField(9)  List<ToppingModel>? toppings, @HiveField(10)  List<AddonModel>? addons, @HiveField(11)  int? discountPercentage, @HiveField(12)  int? averageRating, @HiveField(13)  int? reviewCount, @HiveField(14)  bool? isAvailable, @HiveField(15)  String? workstation, @HiveField(16)  MenuStockModel? stock)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MenuItemModel() when $default != null:
return $default(_that.id,_that.name,_that.originalPrice,_that.discountedPrice,_that.description,_that.mainCategory,_that.subCategory,_that.imageURL,_that.toppings,_that.addons,_that.discountPercentage,_that.averageRating,_that.reviewCount,_that.isAvailable,_that.workstation,_that.stock);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(1)  String id, @HiveField(2)  String? name, @HiveField(3)  int? originalPrice, @HiveField(4)  int? discountedPrice, @HiveField(5)  String? description, @HiveField(6)  String? mainCategory, @HiveField(7)  String? subCategory, @HiveField(8)@JsonKey(name: 'imageUrl')  String? imageURL, @HiveField(9)  List<ToppingModel>? toppings, @HiveField(10)  List<AddonModel>? addons, @HiveField(11)  int? discountPercentage, @HiveField(12)  int? averageRating, @HiveField(13)  int? reviewCount, @HiveField(14)  bool? isAvailable, @HiveField(15)  String? workstation, @HiveField(16)  MenuStockModel? stock)  $default,) {final _that = this;
switch (_that) {
case _MenuItemModel():
return $default(_that.id,_that.name,_that.originalPrice,_that.discountedPrice,_that.description,_that.mainCategory,_that.subCategory,_that.imageURL,_that.toppings,_that.addons,_that.discountPercentage,_that.averageRating,_that.reviewCount,_that.isAvailable,_that.workstation,_that.stock);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@HiveField(1)  String id, @HiveField(2)  String? name, @HiveField(3)  int? originalPrice, @HiveField(4)  int? discountedPrice, @HiveField(5)  String? description, @HiveField(6)  String? mainCategory, @HiveField(7)  String? subCategory, @HiveField(8)@JsonKey(name: 'imageUrl')  String? imageURL, @HiveField(9)  List<ToppingModel>? toppings, @HiveField(10)  List<AddonModel>? addons, @HiveField(11)  int? discountPercentage, @HiveField(12)  int? averageRating, @HiveField(13)  int? reviewCount, @HiveField(14)  bool? isAvailable, @HiveField(15)  String? workstation, @HiveField(16)  MenuStockModel? stock)?  $default,) {final _that = this;
switch (_that) {
case _MenuItemModel() when $default != null:
return $default(_that.id,_that.name,_that.originalPrice,_that.discountedPrice,_that.description,_that.mainCategory,_that.subCategory,_that.imageURL,_that.toppings,_that.addons,_that.discountPercentage,_that.averageRating,_that.reviewCount,_that.isAvailable,_that.workstation,_that.stock);case _:
  return null;
