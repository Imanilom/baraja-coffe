...
@HiveField(14) bool? get isAvailable;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,originalPrice,discountedPrice,description,category,subCategory,imageURL,const DeepCollectionEquality().hash(toppings),const DeepCollectionEquality().hash(addons),discountPercentage,averageRating,reviewCount,isAvailable);

@override
String toString() {
  return 'MenuItemModel(id: $id, name: $name, originalPrice: $originalPrice, discountedPrice: $discountedPrice, description: $description, category: $category, subCategory: $subCategory, imageURL: $imageURL, toppings: $toppings, addons: $addons, discountPercentage: $discountPercentage, averageRating: $averageRating, reviewCount: $reviewCount, isAvailable: $isAvailable)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,originalPrice,discountedPrice,description,category,subCategory,imageURL,const DeepCollectionEquality().hash(_toppings),const DeepCollectionEquality().hash(_addons),discountPercentage,averageRating,reviewCount,isAvailable);
