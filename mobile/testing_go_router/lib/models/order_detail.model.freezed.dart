...
@HiveField(4) List<OrderItemModel> get items;@HiveField(5)@JsonKey(fromJson: OrderStatusModel.fromString, toJson: OrderStatusModel.toJsonString) OrderStatusModel get status;// Pembayaran & Tipe Order
@HiveField(6) String? get paymentMethod;@HiveField(7)@JsonKey(fromJson: OrderTypeModel.fromString, toJson: OrderTypeModel.toJsonString) OrderTypeModel get orderType;// Lokasi
@HiveField(8) String get deliveryAddress;@HiveField(9) String? get tableNumber;@HiveField(10)@JsonKey(fromJson: LocationTypeModel.fromString, toJson: LocationTypeModel.toJsonString) LocationTypeModel get type;@HiveField(11) String? get outlet;// Diskon & Promo
...
as OrderStatusModel,paymentMethod: freezed == paymentMethod ? _self.paymentMethod : paymentMethod // ignore: cast_nullable_to_non_nullable
as String?,orderType: null == orderType ? _self.orderType : orderType // ignore: cast_nullable_to_non_nullable
as OrderTypeModel,deliveryAddress: null == deliveryAddress ? _self.deliveryAddress : deliveryAddress // ignore: cast_nullable_to_non_nullable
...
as LocationTypeModel,outlet: freezed == outlet ? _self.outlet : outlet // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$OrderStatusModelCopyWith<$Res> get status {
  
  return $OrderStatusModelCopyWith<$Res>(_self.status, (value) {
...
@override
@pragma('vm:prefer-inline')
$LocationTypeModelCopyWith<$Res> get type {
  
  return $LocationTypeModelCopyWith<$Res>(_self.type, (value) {
...
@override@HiveField(5)@JsonKey(fromJson: OrderStatusModel.fromString, toJson: OrderStatusModel.toJsonString) final  OrderStatusModel status;
// Pembayaran & Tipe Order
@override@JsonKey()@HiveField(6) final  String? paymentMethod;
@override@HiveField(7)@JsonKey(fromJson: OrderTypeModel.fromString, toJson: OrderTypeModel.toJsonString) final  OrderTypeModel orderType;
// Lokasi
@override@JsonKey()@HiveField(8) final  String deliveryAddress;
@override@JsonKey()@HiveField(9) final  String? tableNumber;
@override@HiveField(10)@JsonKey(fromJson: LocationTypeModel.fromString, toJson: LocationTypeModel.toJsonString) final  LocationTypeModel type;
...
@override $OrderStatusModelCopyWith<$Res> get status;@override $OrderTypeModelCopyWith<$Res> get orderType;@override $LocationTypeModelCopyWith<$Res> get type;@override $DiscountModelCopyWith<$Res>? get discounts;@override $CustomDiscountModelCopyWith<$Res>? get customDiscountDetails;
