...
@HiveField(22) String get source;@HiveField(23) DateTime? get createdAt;@HiveField(24) DateTime? get updatedAt;@HiveField(26) String? get paymentStatus;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,orderId,userId,user,cashierId,const DeepCollectionEquality().hash(_items),status,paymentMethod,orderType,deliveryAddress,tableNumber,type,outlet,discounts,const DeepCollectionEquality().hash(_appliedPromos),appliedManualPromo,appliedVoucher,const DeepCollectionEquality().hash(_taxAndServiceDetails),totalTax,totalServiceFee,totalBeforeDiscount,totalAfterDiscount,grandTotal,source,createdAt,updatedAt,paymentStatus]);
