...
@HiveField(22) String get source;@HiveField(23) DateTime? get createdAt;@HiveField(24) DateTime? get updatedAt;@HiveField(25)@JsonKey(name: 'payment_details') List<PaymentModel>? get payment;@HiveField(26) String? get paymentStatus;@HiveField(27)@JsonKey(name: '_id') String? get id;@HiveField(28) bool get isOpenBill;
