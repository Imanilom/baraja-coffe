...
@HiveField(0)@JsonKey(name: 'userId') String? get customerId;@HiveField(1) String? get customerName;@HiveField(2) String? get cashierId;@HiveField(3) String? get phoneNumber;@HiveField(4) List<OrderItemModel> get items;@HiveField(5) String get orderType;@HiveField(6) String? get deliveryAddress;@HiveField(7) String? get tableNumber;@HiveField(8) String? get paymentMethod;@HiveField(9) String? get status;@HiveField(10) double? get subTotalPrice;@HiveField(11)@JsonKey(name: '_id') String? get orderId;@HiveField(12) double? get tax;@HiveField(13) double? get totalPrice;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,customerId,customerName,cashierId,phoneNumber,const DeepCollectionEquality().hash(items),orderType,deliveryAddress,tableNumber,paymentMethod,status,subTotalPrice,orderId,tax,totalPrice);
...
@useResult
$Res call({
@HiveField(0)@JsonKey(name: 'userId') String? customerId,@HiveField(1) String? customerName,@HiveField(2) String? cashierId,@HiveField(3) String? phoneNumber,@HiveField(4) List<OrderItemModel> items,@HiveField(5) String orderType,@HiveField(6) String? deliveryAddress,@HiveField(7) String? tableNumber,@HiveField(8) String? paymentMethod,@HiveField(9) String? status,@HiveField(10) double? subTotalPrice,@HiveField(11)@JsonKey(name: '_id') String? orderId,@HiveField(12) double? tax,@HiveField(13) double? totalPrice
});
...
/// Create a copy of OrderDetailModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? customerId = freezed,Object? customerName = freezed,Object? cashierId = freezed,Object? phoneNumber = freezed,Object? items = null,Object? orderType = null,Object? deliveryAddress = freezed,Object? tableNumber = freezed,Object? paymentMethod = freezed,Object? status = freezed,Object? subTotalPrice = freezed,Object? orderId = freezed,Object? tax = freezed,Object? totalPrice = freezed,}) {
...
class _OrderDetailModel implements OrderDetailModel {
   _OrderDetailModel({@HiveField(0)@JsonKey(name: 'userId') this.customerId, @HiveField(1) this.customerName, @HiveField(2) this.cashierId, @HiveField(3) this.phoneNumber, @HiveField(4) final  List<OrderItemModel> items = const [], @HiveField(5) required this.orderType, @HiveField(6) this.deliveryAddress, @HiveField(7) this.tableNumber, @HiveField(8) this.paymentMethod, @HiveField(9) this.status, @HiveField(10) this.subTotalPrice, @HiveField(11)@JsonKey(name: '_id') this.orderId, @HiveField(12) this.tax, @HiveField(13) this.totalPrice}): _items = items;
...
@override@HiveField(10) final  double? subTotalPrice;
@override@HiveField(11)@JsonKey(name: '_id') final  String? orderId;
@override@HiveField(12) final  double? tax;
@override@HiveField(13) final  double? totalPrice;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,customerId,customerName,cashierId,phoneNumber,const DeepCollectionEquality().hash(_items),orderType,deliveryAddress,tableNumber,paymentMethod,status,subTotalPrice,orderId,tax,totalPrice);
...
/// Create a copy of OrderDetailModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? customerId = freezed,Object? customerName = freezed,Object? cashierId = freezed,Object? phoneNumber = freezed,Object? items = null,Object? orderType = null,Object? deliveryAddress = freezed,Object? tableNumber = freezed,Object? paymentMethod = freezed,Object? status = freezed,Object? subTotalPrice = freezed,Object? orderId = freezed,Object? tax = freezed,Object? totalPrice = freezed,}) {
