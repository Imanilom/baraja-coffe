...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)@JsonKey(name: '_id')  String id, @HiveField(1)  String outlet, @HiveField(2)  String deviceId, @HiveField(3)  String deviceName, @HiveField(4)  String deviceType, @HiveField(5)  String location, @HiveField(6)  List<String> assignedAreas, @HiveField(7)  List<String> assignedTables, @HiveField(8)  List<String> orderTypes, @HiveField(9)  bool isOnline, @HiveField(10)  Map<String, dynamic>? currentUser, @HiveField(11)  bool isAvailable)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DeviceModel() when $default != null:
return $default(_that.id,_that.outlet,_that.deviceId,_that.deviceName,_that.deviceType,_that.location,_that.assignedAreas,_that.assignedTables,_that.orderTypes,_that.isOnline,_that.currentUser,_that.isAvailable);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)@JsonKey(name: '_id')  String id, @HiveField(1)  String outlet, @HiveField(2)  String deviceId, @HiveField(3)  String deviceName, @HiveField(4)  String deviceType, @HiveField(5)  String location, @HiveField(6)  List<String> assignedAreas, @HiveField(7)  List<String> assignedTables, @HiveField(8)  List<String> orderTypes, @HiveField(9)  bool isOnline, @HiveField(10)  Map<String, dynamic>? currentUser, @HiveField(11)  bool isAvailable)  $default,) {final _that = this;
switch (_that) {
case _DeviceModel():
return $default(_that.id,_that.outlet,_that.deviceId,_that.deviceName,_that.deviceType,_that.location,_that.assignedAreas,_that.assignedTables,_that.orderTypes,_that.isOnline,_that.currentUser,_that.isAvailable);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@HiveField(0)@JsonKey(name: '_id')  String id, @HiveField(1)  String outlet, @HiveField(2)  String deviceId, @HiveField(3)  String deviceName, @HiveField(4)  String deviceType, @HiveField(5)  String location, @HiveField(6)  List<String> assignedAreas, @HiveField(7)  List<String> assignedTables, @HiveField(8)  List<String> orderTypes, @HiveField(9)  bool isOnline, @HiveField(10)  Map<String, dynamic>? currentUser, @HiveField(11)  bool isAvailable)?  $default,) {final _that = this;
switch (_that) {
case _DeviceModel() when $default != null:
return $default(_that.id,_that.outlet,_that.deviceId,_that.deviceName,_that.deviceType,_that.location,_that.assignedAreas,_that.assignedTables,_that.orderTypes,_that.isOnline,_that.currentUser,_that.isAvailable);case _:
  return null;
