...
/// Adds pattern-matching-related methods to [TaxAndServiceModel].
extension TaxAndServiceModelPatterns on TaxAndServiceModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TaxAndServiceModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _TaxAndServiceModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TaxAndServiceModel value)  $default,){
final _that = this;
switch (_that) {
case _TaxAndServiceModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TaxAndServiceModel value)?  $default,){
final _that = this;
switch (_that) {
case _TaxAndServiceModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)@JsonKey(name: '_id')  String? id, @HiveField(1)  String? type, @HiveField(2)  String? name, @HiveField(3)  String? description, @HiveField(4)  int? percentage, @HiveField(5)  int? fixedFee, @HiveField(6)  bool? isActive, @HiveField(7)  List<OutletInfoModel>? appliesToOutlets)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TaxAndServiceModel() when $default != null:
return $default(_that.id,_that.type,_that.name,_that.description,_that.percentage,_that.fixedFee,_that.isActive,_that.appliesToOutlets);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)@JsonKey(name: '_id')  String? id, @HiveField(1)  String? type, @HiveField(2)  String? name, @HiveField(3)  String? description, @HiveField(4)  int? percentage, @HiveField(5)  int? fixedFee, @HiveField(6)  bool? isActive, @HiveField(7)  List<OutletInfoModel>? appliesToOutlets)  $default,) {final _that = this;
switch (_that) {
case _TaxAndServiceModel():
return $default(_that.id,_that.type,_that.name,_that.description,_that.percentage,_that.fixedFee,_that.isActive,_that.appliesToOutlets);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@HiveField(0)@JsonKey(name: '_id')  String? id, @HiveField(1)  String? type, @HiveField(2)  String? name, @HiveField(3)  String? description, @HiveField(4)  int? percentage, @HiveField(5)  int? fixedFee, @HiveField(6)  bool? isActive, @HiveField(7)  List<OutletInfoModel>? appliesToOutlets)?  $default,) {final _that = this;
switch (_that) {
case _TaxAndServiceModel() when $default != null:
return $default(_that.id,_that.type,_that.name,_that.description,_that.percentage,_that.fixedFee,_that.isActive,_that.appliesToOutlets);case _:
  return null;
