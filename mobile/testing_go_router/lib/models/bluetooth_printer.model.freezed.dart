...
/// Adds pattern-matching-related methods to [BluetoothPrinterModel].
extension BluetoothPrinterModelPatterns on BluetoothPrinterModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _BluetoothPrinterModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _BluetoothPrinterModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _BluetoothPrinterModel value)  $default,){
final _that = this;
switch (_that) {
case _BluetoothPrinterModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _BluetoothPrinterModel value)?  $default,){
final _that = this;
switch (_that) {
case _BluetoothPrinterModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)  String name, @HiveField(1)  String address, @HiveField(2)  String? connectionType, @HiveField(3)  String paperSize, @HiveField(4)  bool canPrintCustomer, @HiveField(5)  bool canPrintKitchen, @HiveField(6)  bool canPrintBar, @HiveField(7)  bool canPrintWaiter, @HiveField(8)  int customerCopies, @HiveField(9)  int kitchenCopies, @HiveField(10)  int barCopies, @HiveField(11)  int waiterCopies, @HiveField(12)  int? port, @HiveField(13)  bool isEnabled, @HiveField(14)  DateTime? lastSeen, @HiveField(15)  String? manufacturer, @HiveField(16)  String? model, @HiveField(17)  bool? isOnline)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BluetoothPrinterModel() when $default != null:
return $default(_that.name,_that.address,_that.connectionType,_that.paperSize,_that.canPrintCustomer,_that.canPrintKitchen,_that.canPrintBar,_that.canPrintWaiter,_that.customerCopies,_that.kitchenCopies,_that.barCopies,_that.waiterCopies,_that.port,_that.isEnabled,_that.lastSeen,_that.manufacturer,_that.model,_that.isOnline);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)  String name, @HiveField(1)  String address, @HiveField(2)  String? connectionType, @HiveField(3)  String paperSize, @HiveField(4)  bool canPrintCustomer, @HiveField(5)  bool canPrintKitchen, @HiveField(6)  bool canPrintBar, @HiveField(7)  bool canPrintWaiter, @HiveField(8)  int customerCopies, @HiveField(9)  int kitchenCopies, @HiveField(10)  int barCopies, @HiveField(11)  int waiterCopies, @HiveField(12)  int? port, @HiveField(13)  bool isEnabled, @HiveField(14)  DateTime? lastSeen, @HiveField(15)  String? manufacturer, @HiveField(16)  String? model, @HiveField(17)  bool? isOnline)  $default,) {final _that = this;
switch (_that) {
case _BluetoothPrinterModel():
return $default(_that.name,_that.address,_that.connectionType,_that.paperSize,_that.canPrintCustomer,_that.canPrintKitchen,_that.canPrintBar,_that.canPrintWaiter,_that.customerCopies,_that.kitchenCopies,_that.barCopies,_that.waiterCopies,_that.port,_that.isEnabled,_that.lastSeen,_that.manufacturer,_that.model,_that.isOnline);case _:
  throw StateError('Unexpected subclass');
