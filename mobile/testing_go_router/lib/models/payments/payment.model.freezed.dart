...
switch (_that) {
case _PaymentModel() when $default != null:
return $default(_that.orderId,_that.transactionId,_that.method,_that.status,_that.paymentType,_that.amount,_that.remainingAmount,_that.phone,_that.discount,_that.midtransRedirectUrl,_that.fraudStatus,_that.transactionTime,_that.expiryTime,_that.settlementTime,_that.paidAt,_that.vaNumbers,_that.permataVaNumber,_that.billKey,_that.billerCode,_that.pdfUrl,_that.currency,_that.merchantId,_that.signatureKey,_that.actions,_that.rawResponse,_that.createdAt,_that.updatedAt,_that.tenderedAmount,_that.changeAmount,_that.selectedPaymentType,_that.selectedPaymentMethod);case _:
  return orElse();
