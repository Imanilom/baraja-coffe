...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)  MenuItemModel menuItem, @HiveField(1)  List<ToppingModel> selectedToppings, @HiveField(2)  List<AddonModel> selectedAddons, @HiveField(3)  int quantity, @HiveField(4)  String? notes, @HiveField(5)  int subtotal, @HiveField(6)@JsonKey(name: 'dineType', fromJson: OrderTypeExtension.fromString, toJson: OrderTypeExtension.orderTypeToJson)  OrderType orderType, @HiveField(7)  String? orderItemid, @HiveField(8)  bool isPrinted, @HiveField(9)  int printedQuantity, @HiveField(10)  List<String> printBatchIds)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderItemModel() when $default != null:
return $default(_that.menuItem,_that.selectedToppings,_that.selectedAddons,_that.quantity,_that.notes,_that.subtotal,_that.orderType,_that.orderItemid,_that.isPrinted,_that.printedQuantity,_that.printBatchIds);case _:
  return orElse();
