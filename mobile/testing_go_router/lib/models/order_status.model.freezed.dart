...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OrderStatusModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
...
@override
String toString() {
  return 'OrderStatusModel(id: $id, name: $name)';
}
...
class _OrderStatusModel extends OrderStatusModel {
  const _OrderStatusModel({@HiveField(0) required this.id, @HiveField(1) required this.name}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _OrderStatusModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
