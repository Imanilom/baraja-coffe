...
class AddOrderItemDialogState extends State<AddOrderItemDialog> {
  ...
  late int quantity;
  late String note;
  late OrderType? selectedOrderType = widget.orderItem.orderType;
  ...
  void _saveOrderItems() {
    ...
    for (var orderItem in groupedItemList) {
      ...
      print('mencoba menambahkan data notes item ${orderItem.notes}');
      print('mencoba menambahkan data order type item ${orderItem.orderType}');
      print('------------------------');
