...
class OrderEditorNotifier extends StateNotifier<EditOrderItemModel> {
  ...
  // deleteExistingItem dihapus: semua perubahan (termasuk penghapusan item lama)
  // sekarang di-batch dalam satu PATCH request via submitEditedOrder.
  // Gunakan removeItem() untuk menghapus item secara lokal.
