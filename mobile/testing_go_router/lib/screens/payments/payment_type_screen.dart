...
//     print('paymentMethodsAsync: $paymentMethodsAsync');
...
//         data:
//             (paymentMedhods) => _buildPaymentContent(
//               context,
//               ref,
//               paymentMedhods,
//               state,
...
//               : 'Pilih ${paymentMethod.name} ${state.isDownPayment ? '(untuk Down Payment)' : ''}',
//           style: const TextStyle(
//             fontSize: 16,
//             fontWeight: FontWeight.w600,
...
//                     orderDetailNotifier,
//                   )
//                   : _buildPaymentTypeOptions(paymentMethod, notifier, state),
//         ),
//       ],
//     );
//   }
...
//   ) {
//     final activeTypess =
//         paymentMethod.paymentTypes.where((method) => method.isActive).toList();
...
//             mainAxisSpacing: 12,
//           ),
//           itemCount: activeTypess.length,
//           itemBuilder: (context, index) {
//             final type = activeTypess[index];
//             final isSelected = state.selectedPaymentType?.id == type.id;

//             return GestureDetector(
//               onTap:
//                   () => notifier.selectPaymentType(type, state.isDownPayment),
//               child: AnimatedContainer(
//                 duration: const Duration(milliseconds: 200),
//                 decoration: BoxDecoration(
//                   color: isSelected ? const Color(0xFF2E7D4F) : Colors.grey[50],
