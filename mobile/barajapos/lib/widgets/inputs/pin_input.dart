import 'package:barajapos/widgets/keyboard/custom_keyboard.dart';
...
class _PinInputState extends ConsumerState<PinInput> {
  ...
  void _submitPin() async {
    ...
    await Future.delayed(
        const Duration(seconds: 2)); // Simulasi loading (misalnya API request)
                ...
                : List.generate(
                    ...
                    (index) => Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color:
                            index < pin.length ? Colors.grey[800] : Colors.grey,
                      ),
                    ),
                  ),
          ),
