            ...
            <form onSubmit={handleSubmit} className="space-y-6 ">
                ...
                <div className="grid px-3 grid-cols-1 w-full md:w-1/2 gap-4">
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="relative flex-1">
                                {!showInput2 ? (
                                    ...
                                    >
                                        {tempSelectedOutlet2 || 'Pilih Outlet'}
                                    </button>
                                ) : (
                                    <input
                                        type="text"
                                        ...
                                        {filteredOutlets.length > 0 ? (
                                            filteredOutlets.map((outlet, idx) => (
                                                <li
                                                    key={idx}
                                                    onClick={() => {
                                                        setTempSelectedOutlet2(outlet.name);
                                                        setShowInput2(false);
                                                        setSearch('');
                                                    }}
                                                    className="px-4 py-2 hover:bg-blue-100 cursor-pointer"
                        ...
                        {/* EMAIL */}
                        <div className="flex items-center">
                            <label className="w-[140px] text-[13px] text-[#999999]">Email</label>
                            <input
                                type="email"
                                name="email"
                                value={form.email}
                        ...
                        <table className="table-auto w-full border-gray-300" cellPadding={10}>
                            <thead className="border-b">
                                <tr className="">
                                    ...
                                    <th className="pb-3 text-[14px] text-[#999999] font-semibold w-2/12"></th>
