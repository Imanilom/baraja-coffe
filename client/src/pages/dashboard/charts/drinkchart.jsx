    ...
    return (
        <div className="w-full">
            ...
            <div className="flex items-center gap-2 mb-6">
                <div>
                    <h3 className="text-xl font-black text-gray-800 tracking-tighter">Top Minuman</h3>
                                ...
                                <div key={i} className="group">
                                    ...
                                    <div className="flex justify-between items-end mb-2">
                                        <div className="flex flex-col">
                                            <span className="text-[11px] font-black text-emerald-600 uppercase tracking-widest opacity-70 mb-0.5">#{i + 1}</span>
                                    ...
                                    <div className="w-full bg-gray-100/50 h-2.5 rounded-full overflow-hidden border border-gray-100 shadow-inner">
                                        <div
                                            className="h-full rounded-full bg-gradient-to-r from-[#34d399] to-[#10b981] transition-all duration-1000 ease-out shadow-lg group-hover:brightness-110"
                                            style={{ width: `${percent}%` }}
                                        />
                                    </div>
                                </div>
