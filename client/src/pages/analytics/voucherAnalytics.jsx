...
export default function VoucherAnalytics({ data: externalData = null }) {
    ...
    return (
        <div className="relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                ...
                {/* <KpiCard title="Clicks" value={kpis.clicks} subtitle={`Last ${rangeDays} days`} /> */}
