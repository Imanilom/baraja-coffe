        ...
        <div className="">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 mb-[60px]">
                    ...
                    <div className="px-3 relative mb-10">
                        <table className="table-auto w-full border-gray-300" cellPadding={10}>
                            <thead className="border-b">
                                <tr className="">
                                    <th className="pb-3 text-[12px] text-[#999999] font-semibold text-left w-2/12 after:content-['*'] after:text-red-500 after:text-lg after:ml-1 uppercase">Tanggal</th>
                                    <th className="pb-3 text-[12px] text-[#999999] font-semibold text-left w-2/12 after:content-['*'] after:text-red-500 after:text-lg after:ml-1 uppercase">Nama Pengeluaran</th>
                                    <th className="pb-3 text-[12px] text-[#999999] font-semibold text-left w-2/12 uppercase">Jenis Pengeluaran</th>
                                    <th className="pb-3 text-[12px] text-[#999999] font-semibold text-left w-2/12 uppercase">Supplier</th>
                                    <th className="pb-3 text-[12px] text-[#999999] font-semibold text-left w-2/12 after:content-['*'] after:text-red-500 after:text-lg after:ml-1 uppercase">Outlet</th>
                                    <th className="pb-3 text-[12px] text-[#999999] font-semibold text-right w-1/12 after:content-['*'] after:text-red-500 after:text-lg after:ml-1 uppercase">Jumlah</th>
                                    <th className="pb-3 text-[12px] text-[#999999] font-semibold text-left w-1/12 after:content-['*'] after:text-red-500 after:text-lg after:ml-1 uppercase">Satuan</th>
                                    <th className="pb-3 text-[12px] text-[#999999] font-semibold text-right w-2/12 uppercase">Total Harga</th>
                                    ...
                                    <tr key={index}>
                                        <td className="pt-3">
                                            <input
                                                type="date"
                                                value={row.tanggal}
                                                onChange={(e) => handleRowChange(index, 'tanggal', e.target.value)}
                                        ...
                                        <td className="pt-3">
                                            <input
                                                type="text"
                                                value={row.namaPengeluaran}
                                                onChange={(e) => handleRowChange(index, 'namaPengeluaran', e.target.value)}
                                                className="w-full border px-2 py-1 rounded-lg"
                                            />
                                        </td>
                                        <td className="pt-3">
                                            <input
                                                ...
                                                onChange={(e) => handleRowChange(index, 'jenisPengeluaran', e.target.value)}
                                                className="w-full border px-2 py-1 rounded-lg"
                                            />
                                        </td>
                                        <td className="pt-3">
                                        ...
                                        <td className=" text-right">
                                            <input
                                                type="text"
                                                value={row.outlet}
                                                onChange={(e) => handleRowChange(index, 'outlet', e.target.value)}
                                                className="w-full border px-2 py-1 rounded-lg"
                                            />
                                        </td>
                ...
                <div className="fixed bottom-0 left-64 right-0 flex justify-between border-t px-3 z-50 bg-white">
                    <div className="flex text-[#999999] text-[14px] items-center py-4">
                        <h3>Kolom bertanda <b className="text-red-600">*</b> wajib diisi</h3>
                    </div>
                    <div className="flex space-x-2 text-[#999999] text-[14px]">
                        ...
                        <div className="flex items-center space-x-2">
                            <Link
                                to="/admin/purchase/expenditure-list"
...
export default CreateExpenditureList;