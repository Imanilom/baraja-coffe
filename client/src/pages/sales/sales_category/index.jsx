    ...
    return (
        <div className="min-h-screen bg-gray-100 p-4">
            <div className="max-w-7xl mx-auto">
                <h1 className="text-2xl font-bold text-gray-800 mb-4">Penjualan Per Kategori</h1>
                    ...
                    <table className="min-w-full table-auto mt-8">
                        <thead>
                            <tr>
                                ...
                                <th className="px-4 py-2 text-left font-semibold text-gray-600">Terjual</th>
                                <th className="px-4 py-2 text-left font-semibold text-gray-600">Penjualan Bersih</th>
                                <th className="px-4 py-2 text-left font-semibold text-gray-600">Rata-rata</th>
                            </tr>
                        </thead>
                        <tbody>
                            {orders.map((order) => (
...
export default CategorySalesManagement;