    ...
    return (
        <div className="min-h-screen bg-gray-100 p-4">
            <div className="max-w-7xl mx-auto">
                <h1 className="text-2xl font-bold text-gray-800 mb-4">Penjualan Produk</h1>
                    ...
                    <table className="min-w-full table-auto mt-8">
                        <thead>
                            <tr>
                                ...
                                <th className="px-4 py-2 text-left font-semibold text-gray-600">Penjualan Kotor</th>
                                <th className="px-4 py-2 text-left font-semibold text-gray-600">Diskon Produk</th>
