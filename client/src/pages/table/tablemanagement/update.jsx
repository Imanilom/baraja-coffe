...
const UpdateArea = ({ isOpen, onClose, onSuccess, areaId }) => {
            ...
            const fetchAreaData = async () => {
                ...
                try {
                    ...
                    setForm({
                        ...
                        rentfee,
                        roomSize: {
                            width: roomSize?.width || 1,
                            height: roomSize?.height || 1,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const errorMessage = error.response?.data?.message || 'Gagal memperbarui area';
                        ...
                        <>
                            ...
                            <div className="mb-4">
                                ...
                                <input
                                    ...
                                    className="w-full text-[13px] border py-2 px-3 rounded uppercase focus:outline-none focus:ring-2 focus:ring-green-600"
                                    required
                                />
                            </div>
