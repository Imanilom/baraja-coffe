    ...
    return (
      ...
      `}
            ...
            <div className="relative flex-1">
                <div className="absolute inset-0 overflow-hidden hover:overflow-y-auto custom-scrollbar">
                                                ...
                                                {item.subMenu ? (
                                                    <>
                                                        <button
                                                            ...
                                                            className={`relative w-full flex items-center justify-between py-3 px-4 overflow-hidden font-semibold transition-all ${isSubMenuOpen ? "bg-gray-700 text-white" : "text-gray-300 hover:text-white hover:bg-gray-700"
                                                                }`}
                                                        >
                                                            ...
                                                            <span className="absolute left-0 top-0 h-full w-0 bg-gray-700 hover:w-full transition-all duration-300 ease-out z-0" />
                                                        </button>
                                                                    ...
                                                                    item.subMenu.map((subItem, subIndex) => {
                                                                        ...
                                                                        return (
                                                                            <li key={subIndex}>
                                                                                <Link
                                                                                    to={subItem.path}
                                                                                    className={`relative block py-2 px-4 overflow-hidden transition-all ${isSubActive ? "bg-gray-700 text-white" : "text-gray-300 hover:text-white hover:bg-gray-700"
                                                                                        }`}
                                                                                >
                                                                                    <div className="flex items-center gap-2 relative z-10">
                                                    ...
                                                    <Link
                                                        to={item.path}
                                                        className={`relative block py-3 px-4 overflow-hidden transition-all ${isActive ? "bg-gray-700 text-white" : "text-gray-300 hover:text-white hover:bg-gray-700"
                                                            }`}
                                                    >
                                                        <div className="flex items-center gap-2 relative z-10">
                                                            {item.icon}
