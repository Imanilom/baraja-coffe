        ...
        <div className="">
            ...
            <div className="px-3 py-2 flex justify-between items-center border-b">
                ...
                <div className="flex space-x-2">
                    <button className="bg-[#005429] text-white text-[13px] px-[15px] py-[7px] rounded">Impor</button>
                    <button className="bg-[#005429] text-white text-[13px] px-[15px] py-[7px] rounded">Ekspor</button>
                    <button className="bg-[#005429] text-white text-[13px] px-[15px] py-[7px] rounded">Tambah</button>
                </div>
            </div>
