...
const CreateEvent = () => {
    ...
    const eventType = [
        { value: "free", label: "Tanpa Biaya" },
        { value: "paid", label: "Dikenakan Biaya" }
    ];
                ...
                <div className="px-6 py-4">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div className="flex items-center space-x-3">
                            <div>
                                <h1 className="text-2xl font-bold text-gray-800">Tambah Event</h1>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                            ...
                            <div className="space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Jelaskan secara detail tentang event ini, apa yang akan dipelajari, benefit yang didapat..."
                                        rows="5"
                                        required
                                    />
                                </div>
                        ...
                        <div className="mb-8">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <Select
                                        options={eventType}
                                        value={eventType.find(option => option.value === form.eventType)}
                                        onChange={(selected) =>
                                            setForm(prev => ({ ...prev, eventType: selected.value }))
                                        }
                    ...
                    <div className="px-8 py-6 bg-gray-50 border-t border-gray-200 flex justify-between items-center">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                type="submit"
                                className="px-8 py-3 rounded-xl bg-gradient-to-r from-[#005429] to-[#007038] text-white font-semibold hover:shadow-lg hover:scale-105 transition-all duration-200 flex items-center space-x-2"
                            >
