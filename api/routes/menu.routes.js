...
router.get('/menu-items', getMenuItemsWithRecipes); // Get all MenuItems
router.get('/all-menu-items', getMenuItems); // Get all MenuItems
router.get('/with-recipes/outlet/:outletId', getMenuItemsByOutletWithRecipes); // Get all MenuItems
