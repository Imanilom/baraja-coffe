...
class RequestController {
  ...
  async createRequest(req, res) {
    ...
    try {
      ...
      for (const item of items) {
        ...
        let centralStockDoc = await ProductStock.findOne({ 
          productId, 
        ...
        if (centralStockDoc.currentStock >= quantity) {
          // Masuk ke list transfer dari Gudang Pusat
          transferItems.push({
            productId,
      ...
      const newRequest = new Request({
        ...
        transferItems,   // Barang diambil dari gudang pusat
        purchaseItems,   // Barang harus dibeli
        status: 'pending',
  ...
  async getRequests(req, res) {
    try {
      ...
      // Ubah format response agar jelas terpisah: transfer & purchase
